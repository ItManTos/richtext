...
(function ($) {
    ...
    $.fn.bindRichText = function bindRichText(options) {
        $(".richtext").richtext();
        ...
        bindhotkeys(options && options.hotkeys);

        $(document).on("focusout", ".richtext-zone", function () {
            showTools(this, true, false);
        });
        $(document).on("click", ".richtext-zone", function () {
            showTools(this, true, true);
        });
    ...
    $(document).on('click', '.switch-icon [data-toggle="tab"]', function () {
        ...
        $(this.parentNode).find('[data-toggle="tab"]').each(function () {
            (this == self) ? $(this).addClass("active") : $(this).removeClass("active")
        });
    ...
    function initBar(id, options) {
        ...
        userOptions["error"] = function (reason, detail) {
            showRichTextError(this, reason, detail);
        }
    ...
    var RichText = function (type, element, userOptions) {
        ...
        var options = {
            ...
            error : function (reason, detail) {
                showRichTextError(editor, reason, detail);
            }
        };
        ...
        return this.each(function () {
            ...
            var $this = $(this)
                ...
                if (!data && /destroy|hide/.test(option))
                    return
                    if (!data)
                        $this.data('bs.richtext', (data = new RichText(options)))
